...
class UserEndpoints {
  ...
  static String staffByShopkeeper(String shopkeeperId) =>
      "$baseApiUrl/user/staff/$shopkeeperId";
  static String deleteUser(String userId) =>
      "$baseApiUrl/user/delete-user/$userId";
}
...
class RepairRequestEndpoints {
  ...
  static String reassign(String id) =>
      "$baseApiUrl/repair-requests/reassign/$id";
  ...
  static String technicianNote(String id) =>
      "$baseApiUrl/repair-requests/tech-note/$id";
