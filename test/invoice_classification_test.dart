...
void main() {
  test(
    'classifies both the app\'s short codes and full-phrase legacy types',
    () {
      ...
      expect(_invoice('purchased invoice').classification, 'Purchase Invoice');
      expect(_invoice('Delivery Note').classification, 'Delivery Note');

      expect(_invoice('purchase').isPurchase, isTrue);
      expect(_invoice('Purchase Invoice').isPurchase, isTrue);
      expect(_invoice('purchased invoice').isPurchase, isTrue);
      expect(_invoice('Custom invoice').isPurchase, isFalse);
